 ...
 */
@MultipartConfig
public class ScholarDisplayServlet extends HttpServlet {
...
//			System.out.println(allUsers.length);
		request.setAttribute("scholars", allUsers);
		request.getRequestDispatcher("SholarViewPage.jsp").forward(request, response);
		}
	}
