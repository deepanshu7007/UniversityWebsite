...
public class FdpDeleteServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String fdp_id = request.getParameter("key2");
		System.out.println("this is uid"+uid);
		System.out.println("this is fdp_id"+fdp_id);
		FdpDao dao = new FdpDao(ConnectionProvider.getConnection() );
		dao.deleteFdp(uid,fdp_id);
	}
