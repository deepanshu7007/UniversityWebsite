...
public class PatentDeleteServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String patent_id = request.getParameter("key2");
		System.out.println("this is uid"+uid);
		System.out.println("this is patent_id"+patent_id);
		PatentDao dao = new PatentDao(ConnectionProvider.getConnection() );
		dao.deletePatent(uid,patent_id);
	}
