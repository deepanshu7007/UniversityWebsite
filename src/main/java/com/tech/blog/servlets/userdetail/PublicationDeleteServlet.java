...
public class PublicationDeleteServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String doiNumber = request.getParameter("key2");
		System.out.println("this is uid"+uid);
		System.out.println("this is doiNumber"+doiNumber);
		PublicationDao dao = new PublicationDao(ConnectionProvider.getConnection() );
		dao.deletePublication(uid,doiNumber);
	}
